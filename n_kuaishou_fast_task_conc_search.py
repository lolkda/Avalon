...
export n_kuaishou_fast_search_source="" # cookie源
export n_kuaishou_fast_search_run_number="" # 运行次数 (默认1)
export n_kuaishou_fast_search_min="" # 最低金币
...
export n_kuaishou_fast_search_update_did="" # 低于设定的最少奖励更新did
export n_kuaishou_fast_search_update_did_min="" # did更新阈值(低于该值更新did)
"""
...
Task = importlib.import_module("script.n_kuaishou_fast_task_conc_search")
